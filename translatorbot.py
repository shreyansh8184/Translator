            ...
            if(msg_text == '/start'):
                ...
                if(self.state > trans_rest):
                    ...
                    if(self.state == trans_lang and msg_text != self.initial):
                        ...
                        love = 'https://translate.yandex.net/api/v1.5/tr.json/translate?key=trnsl.1.1.20201103T172057Z.a630d715455f79bc.a2576494c5bf0b44d43d697bb4682b9dfc60ba07&text=' + self.initial + '&lang=' + lang + '&[format=%3Cplain%3E]&[options=1]'
...
# https://translate.yandex.net/api/v1.5/tr.json/translate?key=trnsl.1.1.20201103T172057Z.a630d715455f79bc.a2576494c5bf0b44d43d697bb4682b9dfc60ba07&text=hello&lang=ru&[format=%3Cplain%3E]&[options=1]
